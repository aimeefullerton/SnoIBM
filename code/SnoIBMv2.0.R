...
#=== RUN SIMULATION ============================================================
  ...
  for(dd in 1:length(dat.idx)){
    for(tt in c(6, 18)){ #6am, 6pm
      ...
      if(show.progress == TRUE){
        ...
        if(SecondSpecies == TRUE) cat(length(fish_other$weight[fish_other$survive == 1]), " fish_other: ", quantile(fish_other$weight[fish_other$survive == 1]), "\n")
      }
  ...
  # 3. EGG INCUBATION
      ...
      if(network == "rbm") salmon$Q[salmon$survive == 1] = fncGetNearestAttribute(wq.df[,c("pid", "rid", "ratio", q.field)], salmon[salmon$survive == 1, c("pid", "seg", "ratio")], ssn)[,q.field]
      ...
      if(SecondSpecies == TRUE){
        ...
        fish_other$Q[fish_other$survive == 1] = fncGetNearestAttribute(wq.df[,c("pid", "rid", "ratio", q.field)], fish_other[fish_other$survive == 1,c("pid", "seg", "ratio")], ssn)[,q.field]
      }
